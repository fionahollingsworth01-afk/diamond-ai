export const relationships = [
  ...
  {
    people: ['jace', 'matt'],
    title: 'Jace Callahan and Matt Haskins',
    direct: 'Jace and Matt are family by choice, but their bond carries pressure, challenge, and hard-earned trust.',
    summary: 'Jace and Matt are both strong-willed men who do not always meet the world softly. Their relationship matters because Matt can read danger and structure where Jace reads pressure and pushes back. They can clash, but they are still tied by the family they built and the people they both protect, especially Krys and the younger generation.'
  },
  {
    people: ['jace', 'jake'],
  ...
  {
    people: ['sawyer', 'dawson'],
    title: 'Sawyer Callahan and Dawson Callahan',
    direct: 'Sawyer and Dawson are twin brothers with a close, restless, ambitious bond.',
    summary: 'Sawyer and Dawson push each other, scheme together, and often become a shared headache for the family. They are restless, ambitious, and more alike than either one probably wants to admit. Their bond becomes especially important during the oil storyline, where their shared obsession turns into something bigger than youthful trouble.'
  },
  {
    people: ['jennifer', 'waya'],
    title: 'Jennifer Callahan and Waya Redhawk',
    direct: 'Jennifer and Waya become husband and wife, and their relationship brings Waya and Tsula into Five Oaks.',
    summary: 'Jennifer and Waya’s relationship matters because it forces the family and town to show who they really are. Waya loves Jennifer and brings Tsula with him, and by the end of their book Five Oaks stands for them. Their marriage is not just romantic. It becomes a test of loyalty, acceptance, and whether family means what Five Oaks claims it means.'
  },
  {
    people: ['kai', 'paloma'],
    title: 'Kai Kincaid and Paloma Echevarría',
    direct: 'Kai and Paloma are husband and wife. She is the woman who proves Kai had not given up on love after all.',
    summary: 'Kai had nearly given up on finding love before Paloma’s family came to Red Willow Crossing. Paloma brings warmth, challenge, and a new future into his life. Their marriage expands Five Oaks and begins the next generation of the family in a different way.'
  },
  {
    people: ['wes', 'sami'],
    title: 'Wes Kincaid and Sami Rawlins',
    direct: 'Wes and Sami are husband and wife and part of the next generation of Five Oaks.',
    summary: 'Wes and Sami’s relationship ties Jake and Krys’ family more closely to Luke and Emma’s family. They carry the younger generation forward and have Wesley Lucas, named for Wes and Luke.'
  }
];
